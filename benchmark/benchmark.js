...
import initChafa from 'chafa-wasm';
...
async function main() {
  console.log('Loading chafa-wasm...');
  ...
  const results = {
    ...
    implementation: 'chafa-wasm (baseline)',
  ...
  // Save results
  const resultsPath = join(__dirname, 'results-baseline.json');
